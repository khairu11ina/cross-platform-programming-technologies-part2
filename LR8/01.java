//radioButton 1 radioButton 2 и slider 
...
// System.out.print("123"); JOptionPane.showMessageDialog(jfr, radioButton1.getText());
});
radioButton2.addActionListener(e -> { JOptionPane.showMessageDialog(jfr, radioButton2.getText());
});
}


static JTextArea textArea = new JTextArea(20, 25);
public static void addRightTextPanel(JFrame jfr) { JPanel rightTextPanel = new JPanel(); rightTextPanel.setLayout(new BorderLayout());

textArea.setText("Текстовая область"); textArea.setLineWrap(true); textArea.setWrapStyleWord(true); rightTextPanel.add(textArea, BorderLayout.EAST); jfr.add(rightTextPanel, BorderLayout.EAST);
}
...
// set bg color slider.setBackground(color);
});
}


public static void main(String[] args) { JFrame frame = new JFrame("Lab8");
